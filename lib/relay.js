...
function sequelizeConnection(_ref2) {
  let name = _ref2.name;
  let nodeType = _ref2.nodeType;
  let target = _ref2.target;
  let orderByEnum = _ref2.orderBy;
  let _before = _ref2.before;
  let _after = _ref2.after;
  let connectionFields = _ref2.connectionFields;
  let edgeFields = _ref2.edgeFields;
  ...
  const connectionType = _connectionDefinition.connectionType;
  ...
  let orderByAttribute = function orderByAttribute(orderBy) {
    return orderBy[0][0];
  };
  ...
  let $resolver = require('./resolver')(target, {
    ...
    after: (() => {
      var _ref4 = (0, _bluebird.coroutine)(function* (values, args, context, _ref3) {
